function [q_s_matrix, theata_ps_matrix, t] = HFComputation_Numerical_VariableParam(ThermalDiffus_p, ThermalDiffus_b,...
    ThermalConduc_p, ThermalConduc_b, ThermalDiffus_p_Func, ThermalDiffus_b_Func, ThermalConduc_p_Func,...
        ThermalConduc_b_Func, Theata_ps, L, ymax_b, tmax, ny_p, ny_b, nt, tolerance, IterTimes)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% HFComputation_Numerical: recover the heat flux from the inverse problem based on
%                          the numerical method (the thermal conductivity and diffusivity
%                          are sensitive with the temperature change)
% 
...
UnitHFMatrix = UnitHFMatrixComputation_VariableParam(ThermalDiffus_p, ThermalDiffus_b,...
    ThermalConduc_p, ThermalConduc_b, ThermalDiffus_p_Func, ThermalDiffus_b_Func, ThermalConduc_p_Func,...
...
theata_ps_matrix = [];
[theata_p, y_p, err_p, theata_b, y_b, err_b, t] = ForwardNumerical_BTCS1_VariableParam( ThermalDiffus_p,...
        ThermalDiffus_b, ThermalConduc_p, ThermalConduc_b, ThermalDiffus_p_Func, ThermalDiffus_b_Func,...
        HF, ThermalConduc_p_Func, ThermalConduc_b_Func, L, ymax_b, tmax, ny_p, ny_b, nt);
