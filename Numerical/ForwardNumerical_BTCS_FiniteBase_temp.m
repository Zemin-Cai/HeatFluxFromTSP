function [theata_p, y_p, err_p, theata_b, y_b, err_b, t] = ForwardNumerical_BTCS_FiniteBase_temp( ThermalDiffus_p,...
    ThermalDiffus_b, q_s, ThermalConduc_p, ThermalConduc_b, L_p, L_b, tmax, ny_p, ny_b, nt, h_c)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% this version is to generate surface temperature for the paper, q_s used
% instead of calculation using FuncComputation function
% Modified by Zemin Cai 2017.08.11
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
