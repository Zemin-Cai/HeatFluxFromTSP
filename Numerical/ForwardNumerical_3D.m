function [TemperatureMatrixes_p, TemperatureMatrixes_b, SurfaceTemperatureMatrixes, dx, dy, dz_p, dz_b, dt] = ForwardNumerical_3D( ThermalConduc_p,...
    ThermalDiffus_p, ThermalConduc_b, ThermalDiffus_b, HeatFluxMatrixes, L, ymax_b, Model_Width, Model_Height, tmax, ny_p, ny_b, nt);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Forward Numerical Temperature Simulation for 3D case (Lateral effect)
%
% Syntax: ForwardNumerical_3D(...)
%
% Input arguments:
...
%                    structure
%  L: the length of the polymer layer, unit is m
%  ymax_b: the length of the base
...
for x = 1:2
    for y = 1:Image_Height
        ...
        [theata_p, y_p, err_p, theata_b, y_b, err_b, t] = ForwardNumerical_BTCS1( ThermalDiffus_p,...
                ThermalDiffus_b, HFAtOnePoint', ThermalConduc_p, ThermalConduc_b, L, ymax_b, tmax, ny_p, ny_b, nt);
        for i = 1:ny_p
            for j = 1:nt
...
for pixel_x = 1:Image_Width
        for pixel_z = 1:Image_Height
            ...
            [q_s, t] = HFComputation_GeneralCase( ThermalDiffus_p, ThermalConduc_p, ThermalDiffus_b,...
                ThermalConduc_b, L, Theata_ps_3D, t);
            ...
            [q_s_matrix, theata_ps_matrix, t] = HFComputation_Numerical(ThermalDiffus_p, ThermalDiffus_b,...
                ThermalConduc_p, ThermalConduc_b, Theata_ps_3D, L, ymax_b, tmax, ny_p, ny_b, nt, tolerance, IterTimes);
            q_s = q_s_matrix(:, end);
            ComputationalTime = cputime - ComputationalTime;
