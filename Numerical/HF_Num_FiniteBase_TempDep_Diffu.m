function [q_s_matrix, theata_ps_matrix, t] = HF_Num_FiniteBase_TempDep(ThermalDiffus_p, ThermalDiffus_b,...
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function: recover the heat flux from the inverse problem 
...
% 
% Syntax:  HF_Num_FiniteBase_TempDep(...)
%
% Input arguments:
