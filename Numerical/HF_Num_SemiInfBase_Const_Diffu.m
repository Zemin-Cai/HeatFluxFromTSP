function [q_s_matrix, theata_ps_matrix, t] = HF_Num_SemiInfBase_Const_Diffu(ThermalDiffus_p, ThermalDiffus_b,...
    ThermalConduc_p, ThermalConduc_b, Theata_ps, L, ymax_b, tmax, ny_p, ny_b, nt, tolerance, IterTimes)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function: recover the heat flux from the inverse problem based on
