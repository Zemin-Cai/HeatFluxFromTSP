function [theata_p, y_p, err_p, theata_b, y_b, err_b, t] = ForwardNumSolu_SemiInfBase_Const_Diff( ThermalDiffus_p,...
    ThermalDiffus_b, HeatfluxVec, ThermalConduc_p, ThermalConduc_b, L, ymax_b, tmax, ny_p, ny_b, nt)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function: Using the Backward Time, Centered Space Scheme to solve 
%                        the forward heat transfer problem (the heat flux value are given)
% 
% Syntax:  ForwardNumSolu_SemiInfBase_Const_Diff(...)
%
% Input arguments:
