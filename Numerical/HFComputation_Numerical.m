function [q_s_matrix, theata_ps_matrix, t] = HFComputation_Numerical(ThermalDiffus_p, ThermalDiffus_b,...
    ThermalConduc_p, ThermalConduc_b, Theata_ps, L, ymax_b, tmax, ny_p, ny_b, nt, tolerance, IterTimes)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[theata_p, y_p, err_p, theata_b, y_b, err_b, t] = ForwardNumerical_BTCS1( ThermalDiffus_p,...
    ThermalDiffus_b, HF, ThermalConduc_p, ThermalConduc_b, L, ymax_b, tmax, ny_p, ny_b, nt);
