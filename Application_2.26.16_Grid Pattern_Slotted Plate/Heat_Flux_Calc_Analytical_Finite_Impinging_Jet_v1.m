...
% dlmwrite('Ts_t_analy_finite.dat',data_out1);
% dlmwrite('qs_t_analy_finite.dat',data_out2);
% dlmwrite('Nu_t_analy_finite.dat',data_out3);
...
% dlmwrite('qs_x_analy_finite.dat',data_out4);
% dlmwrite('Nu_x_analy_finite.dat',data_out5);
