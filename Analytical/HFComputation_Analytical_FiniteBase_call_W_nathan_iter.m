function [q_s, t, epsilon_ba, Delta] = HFComputation_Analytical_FiniteBase_call_W_nathan_iter( ThermalDiffus_p, ThermalConduc_p, ThermalDiffus_b,...
...
[W_Fun, t] = W_fun_nathan_iter(ThermalDiffus_p, ThermalConduc_p, ThermalDiffus_b,...
    ThermalConduc_b, L_polymer, L_base, t, h_c);
...
q_s = (ThermalConduc_p./sqrt(ThermalDiffus_p*pi)).*q_s';
